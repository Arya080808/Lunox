...
$currentQuantity = $result['availability'];
...
$new_availability = $dbh->prepare("UPDATE videocart SET availability=($currentQuantity - 1) WHERE productId = $id");
...
$new_availability->bindParam(':productId', $selectedProductId);
